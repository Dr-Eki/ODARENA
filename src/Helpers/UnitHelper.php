...
class UnitHelper
{
    ...
    public function getUnitHelpString(string $unitType, Race $race, array $unitPowerWithPerk = null): ?string
    {
        ...
        $helpStrings = [
            'draftees' => 'Used for training other units.',
        ...
        $perkTypeStrings = [
            ...
            'defense_from_active_self_spells' => '%+g defensive power per active aura (passive self-spell).',

            'offense_from_target_active_offensive_spells' => '%+g offensive power vs active sorcery aura (passive offensive spell).',
            'defense_from_target_active_offensive_spells' => '%+g defensive power vs active sorcery aura (passive offensive spell).',
            ...
            'counts_as_wizard_on_offense_from_terrain' => 'Counts as %1$s wizard on offense for every %2$s%% %3$s.',
            ...
            'burns_peasants_on_attack' => 'Burns circa %s%% enemy peasants on attack (unless overwhelmed).',
