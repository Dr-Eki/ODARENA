...
class ResearchHelper
{
    ...
    public function getTechPerkDescription(string $techPerk): string
    {

        $techPerkDescriptions = [
        ...
        return isset($techPerkDescriptions[$techPerk]) ? $techPerkDescriptions[$techPerk] : 'Missing description';
    }
