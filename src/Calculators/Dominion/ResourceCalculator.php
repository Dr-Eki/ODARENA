...
class ResourceCalculator
{
    ...
    public function getProductionRaw(Dominion $dominion, string $resourceKey): float
    {
        ...
        if($wpaProductionPerk = $dominion->getBuildingPerkValue($resourceKey . '_production_raw_from_wizard_ratio'))
        {
        #    dd($wpaProductionPerk, $dominion->getBuildingPerkValue($resourceKey . '_production_raw_from_wizard_ratio') * min(10, $this->magicCalculator->getWizardRatio($dominion, 'defense')));
        }
