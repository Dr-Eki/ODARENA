        ...
        return $self->round->activeDominions()
            ...
            ->filter(function ($dominion) use ($self) {
                return (
                    ...
                    (in_array($dominion->round->mode, ['standard','standard-duration','artefacts','artefacts-packs','factions','factions-duration','packs','packs-duration']) ? ($dominion->realm->id == $self->realm->id) : false) and
