                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                @foreach($availableBuildings->where('category', $categoryKey)->sortBy('name') as $building)
                                    @php
                                        $amountOwned = $selectedDominion->getBuildingAmount($building->key);#{'building_' . $building->key};#$buildingCalculator->getBuildingAmountOwned($selectedDominion, $building);
