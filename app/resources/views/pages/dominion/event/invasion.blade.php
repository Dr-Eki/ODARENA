                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-sm-4 text-center">
                            ...
                            @if(!$event->source->isAbandoned() and $event->source->user->hasAvatar()))
                        ...
                        <div class="col-sm-4 text-center">
                            ...
                            @if(!$event->target->isAbandoned() and $event->target->user->hasAvatar())
