                            ...
                            <div class="box-footer">
                              ...
                              @else
                                @if($selectedDominion->race->name == 'Dimensionalists')
                                    ...
                                    @else
                                        <span class="label label-danger">You need at least {{ number_format($selectedDominion->race->getPerkValue('cosmic_alignment_to_invade')) }} Cosmic Alignments to plot a chart to teleport units.
                                            Currently: {{ number_format($selectedDominion->resource_cosmic_alignment) }}.</span>
                                    @endif
