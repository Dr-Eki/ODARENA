                ...
                <tbody>
                    @foreach ($unitHelper->getUnitTypes($dominion->race) as $unitType)
                        <tr>
                            ...
                            @for ($i = 1; $i <= 12; $i++)
                                @php
                                    $amount = $unitCalculator->getQueuedIncomingUnitTypeAtTick($dominion, $unitType, $i);
                                @endphp
                                <td class="text-center">
                                    @if ($amount === 0)
                                        -
                            ...
                            <td class="text-center">
                                ...
                                ({{ number_format($unitCalculator->getUnitTypeTotalIncoming($dominion, $unitType)) }})
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                ...
                <tbody>
                    @foreach ($landHelper->getLandTypes() as $landType)
                        <tr>
                            ...
                            @endfor
                            <td class="text-center">{{ number_format($queueService->getInvasionQueueTotalByResource($dominion, "land_{$landType}")  + $queueService->getExpeditionQueueTotalByResource($dominion, "land_{$landType}")) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
